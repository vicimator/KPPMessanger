...
public class Error_register_pass extends JFrame 
{
	...
	private void initGUI()
	{
		...
		msgLabel.setText("<html>You entered two different passwords.<br>Passwords must be equal. </html>");
...
public static void main(String[] args) 
{
		EventQueue.invokeLater(new Runnable(){
			...
			public void run() 
			{
				try 
				{
					Error_register_pass frame = new Error_register_pass();
