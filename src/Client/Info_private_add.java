...
public class Info_private_add extends JFrame 
{
	...
	private void initGUI()
	{
		...
		msgLabel.setText("<html><center>You already open private messages with this person.</center></html>");
...
public static void main(String[] args) 
{
		EventQueue.invokeLater(new Runnable(){
			...
			public void run() 
			{
				try 
				{
					Info_private_add frame = new Info_private_add();
